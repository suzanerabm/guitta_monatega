...
import { KammaraCardRegion } from './KammaraCardRegion';

const meta: Meta<typeof KammaraCardRegion> = {
  title: 'Kammara/KammaraCardRegion',
  component: KammaraCardRegion,
  tags: ['autodocs'],
...
export default meta;
type Story = StoryObj<typeof KammaraCardRegion>;
